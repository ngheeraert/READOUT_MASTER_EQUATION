...
s = system( g=g,w=w,wd=wd,gamma=gamma,Ad=Ad,\
           cavity_dim=35, qubit_dim=2, dvice='TRSM1',\
           atol=1e-8,rtol=1e-6, max_step=1e-3, dim_exp=100, qb_ini=[1], coupling_type='11' )
#s.set_initial_cs_state( alpha=0 ) 
s.set_initial_photon_state( 1 ) 
...
s.save_and_plot( times, rhos, [0], max_lambda=3 )
#s.save_husimi_for_gif( times, rhos, max_lambda=8, frame_nb=100, log=False )
